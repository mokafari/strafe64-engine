/*
 * TweetNaCl -- vendored, unmodified upstream reference crypto.
 * Public domain. Source: https://tweetnacl.cr.yp.to/
 *
 * DO NOT EDIT. Re-derive any change from upstream so this can't silently
 * diverge from the audited reference implementation.
 */
#include "tweetnacl.h"
