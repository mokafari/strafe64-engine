...
void RB_StageIteratorGeneric( void )
{
	...
	// STRAFE 64 PSX look: affine (non-perspective-correct) texture mapping
	// is the signature texture swim/warp of PlayStation-era 3D. Gated by
	// r_psx so the renderer is otherwise unchanged.
	qglHint( GL_PERSPECTIVE_CORRECTION_HINT, r_psx->integer ? GL_FASTEST : GL_NICEST );
