...
void SP_trigger_race_start (gentity_t *ent);
void SP_trigger_race_finish (gentity_t *ent);
...
void SP_slice_drone( gentity_t *ent );
...
spawn_t	spawns[] = {
	...
	{"trigger_race_start", SP_trigger_race_start},
	{"trigger_race_finish", SP_trigger_race_finish},
...
void SP_worldspawn( void ) {
	...
	// g_voidRise scales the rate (0 disables, for free practice)
	{
		...
		if ( voidRise > 0 ) {
			...
			trap_SetConfigstring( CS_VOIDINFO, "" );
		}
	}
