...
#ifdef USE_CODEC_MOD
extern snd_codec_t mod_codec_it;
extern snd_codec_t mod_codec_xm;
extern snd_codec_t mod_codec_s3m;
extern snd_codec_t mod_codec_mod;
extern snd_codec_t mod_codec_mptm;
